...
# next we can look through the region names from our experiment and get the corresponding structure ids
load(paste(params$opdir,'processed/total_pathdata.RData',sep=''))  # load path data and ROI names (using total path)
